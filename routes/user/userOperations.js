...
router.post('/adduser', function(req,res){
	...
	connection.query(chkQry,function(errr,results){
		if(results.length<1){
			...
			var data = ['user_first_name','user_last_name','user_mobile_number','user_altmobile_number','user_email','user_type',req.body.u_fname,req.body.u_lname,req.body.u_mobile,req.body.u_altmobile,req.body.u_email,req.body.u_type];
